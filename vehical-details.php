...
$sql = "SELECT * from tblbooking where FromDate>='$fromdate' and ToDate<='$todate' and VehicleId='$vhid'";
...
if($query->rowCount() > 0)
{
	echo "<script>alert('This vehicle is Unavailable');</script>";
}
else
	{
...
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/images/favicon-icon/carlogo.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="assets/images/favicon-icon/carlogo.png">
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="assets/images/favicon-icon/carlogo.png">
<link rel="apple-touch-icon-precomposed" href="assets/images/favicon-icon/carlogo.png">
<link rel="shortcut icon" href="assets/images/favicon-icon/carlogo.png">
        ...
        <div class="main_features">
          <ul>
			...
			<li> <i class="fa fa-car" aria-hidden="true"></i>
              <h5><?php echo htmlentities($result->Vehicleid);?></h5>
              <p>Vehicle No</p>
            </li>
          </ul>
        </div>
